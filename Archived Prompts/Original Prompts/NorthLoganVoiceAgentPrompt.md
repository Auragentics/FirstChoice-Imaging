...
- Pricing questions (CT, Lung Screening costs)
- Location and hours
...
### Records/Billing/Insurance Inquiry (Info Collection)
...
**Caller:** "He had a CT scan last week."
**Agent:** [Stores: `{{records_imaging_service}}` = "CT", `{{records_imaging_dos}}` = "Approx 1 week ago"]
...
**Caller:** "June 10, 1970."
**Agent:** [Stores: `{{records_patient_name}}` = caller_name, `{{records_patient_dob}}` = "1970-06-10"]
**Agent:** "What type of imaging was it, and when was it done?"
**Caller:** "Lung screening, about three weeks ago."
**Agent:** [Stores: `{{records_imaging_service}}` = "Lung Screening", `{{records_imaging_dos}}` = "Approx 3 weeks ago"]
**Agent:** "And where should we send the records — email or fax?"
**Caller:** "Email, sarah@example.com."
**Agent:** [Stores: `{{records_delivery_method}}` = "email", `{{records_delivery_destination}}` = "sarah@example.com", sets `{{intents_handled}}` = "medical_records"]
...
**Agent:** "And what is your date of birth?"
**Caller:** "June 10, 1970."
**Agent:** [Stores: `{{billing_patient_dob}}` = "1970-06-10"]
