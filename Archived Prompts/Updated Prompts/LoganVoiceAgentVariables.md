...
| `{{contact.intents_handled}}` | `string` (comma-separated) | Completed workflows during this call | "medical_records,billing" |
...
```json
{
  ...
  "contact.intents_handled": "medical_records",
...
```json
{
  ...
  "contact.intents_handled": "medical_records,billing",
  "contact.records_caller_type": "patient",
  "contact.records_release_required": "NO",
